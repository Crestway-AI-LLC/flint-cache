...
CORE="${FLINT_CORE_ORDER:-restart repl kill_release failover proxy slot_migrate slot_map rebalance_execute
      ...
      write_deadline fullsync_rate edge_reroute rewind_rejoin wal_headroom evictable_ns roll_shed proxy_chain}"
