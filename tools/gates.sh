...
CORE="${FLINT_CORE_ORDER:-kill_order restart repl kill_release failover proxy slot_migrate slot_map rebalance_execute
      ...
      walgap_quarantine three_member_repoint pipeline_nodelay batch_commit_failure build_read_failure cp_watch_idle reattach_node induced_ratchet collection_admission}"
