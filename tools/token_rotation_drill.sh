...
C1=$(valkey-cli -p 7701 PROXYAUTHCOUNT tok-v1)
C2=$(valkey-cli -p 7701 PROXYAUTHCOUNT tok-v2)
...
BEFORE=$(valkey-cli -p 7701 PROXYAUTHCOUNT tok-v1)
# Simulate: clients now only use v2.
for i in $(seq 1 10); do a tok-v2 PING >/dev/null; done
AFTER=$(valkey-cli -p 7701 PROXYAUTHCOUNT tok-v1)
