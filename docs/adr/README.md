...
| [0028](0028-a-verdict-must-name-what-it-examined.md) | A verdict must name what it examined, and the naming must be refutable: five checks passed in one day about subjects nobody had asked about, and every one was caught by something that PRINTED what it looked at rather than by the check's own result (proposed) |
