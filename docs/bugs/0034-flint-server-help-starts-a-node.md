...
<!-- Merged 2026-09-02 from 0034-flint-server-ignores-unknown-arguments.md,
     which carried this section as a second file under the SAME number 0034
     and no title of its own. Its commits (a1eb05d5, 59accb60) are both
     titled BUG-0034, so it was always this write-up. -->
